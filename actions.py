...
class ActionCapital(Action):
    """This action class will post request to api and retrieve capital of desired country."""
...
class ActionPopulation(Action):
    """This action class will post request to api and retrieve population of desired country."""
